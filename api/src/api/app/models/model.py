...
class Model(BaseModel):
    ...
    parameter_definitions: List[StrictStr] = Field(alias="parameterDefinitions")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "compartments", "groups", "parameterDefinitions"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "parameterDefinitions": obj.get("parameterDefinitions")
        })
        return _obj
